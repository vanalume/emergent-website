        ...
        <div className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative flex items-center justify-center">
            <div className="absolute h-64 w-64 md:h-80 md:w-80">
              {[0, 1, 2].map((r) => (
                <motion.span key={r} className="absolute inset-0 rounded-full border border-[#d4a574]/30"
  ...
  return (
    <section ref={ref} className="relative h-[70vh] min-h-[440px] overflow-hidden">
      <motion.div style={{ y: y }} className="absolute inset-0 -top-[8%] -bottom-[8%]">
        <img src={IMAGES.heroEquilibrium} alt="Vanalume craft" className="h-full w-full object-cover" />
        <div className="absolute inset-0 bg-[#2b2823]/55" />
      </motion.div>
    ...
    <div data-testid="about-page">
      ...
      <section className="pb-24 md:pb-32 bg-[#f5f1ea] pt-24 md:pt-32">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-6 text-[#2b2823]/85 text-xl md:text-2xl leading-relaxed font-display">
