...
PRODUCTS = [
    ...
    {"id": "single-rose",            "category": "single", "collection": "Bloom",         "name": "Rose",           "fragrances": ["Rose"],            "mrp": 999, "sp": 599, "images": [IMG["s_rose"]],        "desc": "Single Bloom candle · Rose. Fresh, dewy, garden-in-the-morning.",                "long_desc": "One 180 ml Rose candle from the Bloom duet. A clean, dewy rose — the fresh half of the Bloom ritual."},
    {"id": "single-jasmine",         "category": "single", "collection": "Bloom",         "name": "Jasmine",        "fragrances": ["Jasmine"],         "mrp": 999, "sp": 599, "images": [IMG["s_jasmine"]],        "desc": "Single Bloom candle · Jasmine. Warm, indulgent, floral.",                         "long_desc": "One 180 ml Jasmine candle from the Bloom duet. Warm and full white-floral — the sweeter half of the Bloom ritual."},
    ...
    {"id": "single-aqua",            "category": "single", "collection": "Clarity",       "name": "Aqua",           "fragrances": ["Aqua"],            "mrp": 999, "sp": 599, "images": [IMG["s_aqua"]],      "desc": "Single Clarity candle · Aqua. Cool, clean, quietly watery.",                      "long_desc": "One 180 ml Aqua candle from the Clarity duet. Cool and clean — the calming half of the Clarity ritual."},
    ...
    # ============ CONCRETE JAR ============
    {"id": "concrete-jar-meadow-lace", "category": "concrete-jar", "collection": "Concrete Jar", "name": "Meadow Lace",
     "fragrances": ["Neroli", "Black Oudh", "Tuberose", "Sandalwood", "Musk", "Cedarwood"],
     "mrp": 2299, "sp": 1799, "images": [IMG["library"]],
     "desc": "The complete discovery experience, six fragrances.",
     "long_desc": "Odyssey is Vanalume's complete tasting menu — six discovery-size candles across Neroli, Black Oudh, Tuberose, Sandalwood, Musk and Cedarwood. It's how we recommend starting if you don't yet know which fragrance is yours."},
